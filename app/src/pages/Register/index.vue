<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>验证码:</label>
        <input type="text" placeholder="请输入验证码" v-model="code" class="codeStyle">
<!--        获取验证码时的等待时间设置-->
        <button style="width:100px;height: 38px" @click="getCode" ref="code">获取验证码</button>
<!--        <button style="width:100px;height: ">-->
