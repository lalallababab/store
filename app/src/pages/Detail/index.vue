          ...
          <div class="goodsDetail">
            ...
            <div class="priceArea">
              <div class="priceArea1">
                <div class="title">{{ skuInfo.price }}</div>
                <div class="price">
                  <i>¥</i>
                  <em>5299</em>
                  <span>降价通知</span>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList"
                  :key="spuSaleAttr.id">
                <dt class="title">{{ spuSaleAttr.saleAttrrName }}</dt>
                <dd
                    changepirce="0"
...
export default {
  ...
  methods: {
    //加入购物车的回调函数
    async addShopcar() {
      //派发请求 将产品加入到数据库  可以进行失败或成功的判断 回的是一个promise结果  不需要三连环捞数据了 所以要确定服务器是收到数据了
