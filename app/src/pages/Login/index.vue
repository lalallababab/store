...
<script>
  export default {
    ...
    methods:{
     async userLogin() {
        try{
          const {phone,password,isKeepSecret} = this;
          if(phone&&password){
            this.$store.dispatch('user/userLogin',{phone,password,isKeepSecret});
            this.$message.success("登录成功");
            let redirect = this.$route.query.redirect||"/";
            this.$router.push(redirect)
          }
          // (phone&&password)&&(this.$store.dispatch('user/userLogin',{phone,password,isKeepSecret}))
